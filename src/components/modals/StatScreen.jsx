  ...
  return ReactDOM.createPortal(
    ...
    >
      <div className="modal" onClick={props.onClose}>
        <div className="modal-content stat-modal-content" onClick={e => e.stopPropagation()}>
          ...
          <div className="modal-body">
            ...
            <h4>Win %: {parseInt(JSON.parse(localStorage.getItem('wins')))/parseInt(JSON.parse(localStorage.getItem('gamesPlayed')))*100}%</h4>
            </div>
        </div>
      </div>
    </CSSTransition>,
